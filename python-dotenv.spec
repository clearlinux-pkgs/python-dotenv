...
Source0  : https://files.pythonhosted.org/packages/66/94/286b7b88e24a7a2f3e020234524e3dc3dfdba313f299054b24b8d4d39b77/python-dotenv-0.17.1.tar.gz
...
%prep
%setup -q -n python-dotenv-0.17.1
cd %{_builddir}/python-dotenv-0.17.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620758803
...
cp %{_builddir}/python-dotenv-0.17.1/LICENSE %{buildroot}/usr/share/package-licenses/python-dotenv/36fe354f4526001c781c4c99847c059ebc00878c
