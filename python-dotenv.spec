...
%prep
%setup -q -n python-dotenv-0.19.0
cd %{_builddir}/python-dotenv-0.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630688604
...
cp %{_builddir}/python-dotenv-0.19.0/LICENSE %{buildroot}/usr/share/package-licenses/python-dotenv/36fe354f4526001c781c4c99847c059ebc00878c
